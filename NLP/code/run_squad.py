...
def train(args, train_dataset, model, tokenizer, group_dict):
    """ Train the model """
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.sync == "ds_sync":
                    group_obj = group_dict[torch.distributed.get_rank()][global_step%2]
...
def main():
    ...
    parser.add_argument("--sync", type=str, default="bsp", help="sychronize methods")
    ...
    if args.do_train:
        ...
        global_step, tr_loss = train(args, train_dataset, model, tokenizer, group_dict)
